...
public abstract class URPGCommands {
    private final @NotNull String label;
    private final @NotNull Set<String> alias;
    private @Nullable String permission;

    protected URPGCommands(@NotNull String label, String... alias) {
        this.label = label;
        this.alias = Sets.newHashSet(alias);
        this.setPermission("urpg." + label);
    }

    public static @NotNull Stream<URPGCommands> filterByPermission(@NotNull CommandSender sender, @NotNull Stream<URPGCommands> commands) {
